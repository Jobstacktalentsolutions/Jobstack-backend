...
import { AdminJwtGuard, EmployerJwtGuard, JobSeekerJwtGuard } from 'apps/api/src/guards';
...
@Module({
  ...
  providers: [SkillsService, AdminJwtGuard, JobSeekerJwtGuard, EmployerJwtGuard],
