...
export class Migration1761746501702 implements MigrationInterface {
    name = 'Migration1761746501702'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // cleanup orphans before enforcing FK
        await queryRunner.query(`DELETE FROM "jobseeker_skills" js WHERE NOT EXISTS (SELECT 1 FROM "jobseeker_profiles" jp WHERE jp."id" = js."profileId")`);
        await queryRunner.query(`ALTER TABLE "jobseeker_skills" ADD CONSTRAINT "FK_cfa1ce19f08e80c277d7ad98e6c" FOREIGN KEY ("profileId") REFERENCES "jobseeker_profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION NOT VALID`);
