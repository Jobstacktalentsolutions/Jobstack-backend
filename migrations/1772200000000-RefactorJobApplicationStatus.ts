...
export class RefactorJobApplicationStatus1772200000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."job_applications_status_enum" RENAME VALUE 'EMPLOYER_ACCEPTED' TO 'OFFER_SENT'`,
    );
    ...
    await queryRunner.query(
      `UPDATE "job_applications" SET "status" = 'APPLICANT_ACCEPTED' WHERE "status" = 'AWAITING_PAYMENT'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."job_applications_status_enum" AS ENUM('APPLIED', 'VETTED', 'SELECTED_FOR_SCREENING', 'SELECTED_FOR_HIRE', 'OFFER_SENT', 'APPLICANT_ACCEPTED', 'HIRED', 'REJECTED', 'WITHDRAWN')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."job_applications_status_enum" AS ENUM('APPLIED', 'VETTED', 'SELECTED_FOR_SCREENING', 'SELECTED_FOR_HIRE', 'EMPLOYER_ACCEPTED', 'APPLICANT_ACCEPTED', 'AWAITING_PAYMENT', 'OFFERED', 'HIRED', 'REJECTED', 'WITHDRAWN')`,
    );
    await queryRunner.query(
      `UPDATE "job_applications" SET "status" = 'EMPLOYER_ACCEPTED' WHERE "status" = 'OFFER_SENT'`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_applications" ALTER COLUMN "status" TYPE "public"."job_applications_status_enum" USING "status"::text::"public"."job_applications_status_enum"`,
    );
